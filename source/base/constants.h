...
extern std::string STRING_DEFAULT_GM;       //!< Gravitational constant of the Earth (EGM96), in string.
extern std::string STRING_DEFAULT_R;        //!< Reference radius (EGM96), in string.
extern std::string STRING_DEFAULT_GRS80_a;  //!< Semi-major axis of Earth's ellipsoid, in string.
extern std::string STRING_DEFAULT_GRS80_f;  //!< Inverse flattening of Earth's ellipsoid, in string.
...
extern Double GM_MERCURY;            //!< Gravitational constant of the Mercury (Used in Planets).
extern Double GM_VENUS;              //!< Gravitational constant of the Venus (Used in Planets).
extern Double GM_MARS;               //!< Gravitational constant of the Mars (Used in Planets).
extern Double GM_JUPITER;            //!< Gravitational constant of the Jupiter (Used in Planets).
extern Double GM_SATURN;             //!< Gravitational constant of the Saturn (Used in Planets).
...
extern Double      DELTA_TAI_GPS;  //!< Seconds to be added to GPS time to get TAI, 19 seconds.
extern Double      DELTA_TT_GPS;   //!< Seconds to be added to GPS time to get TT, 51.184 seconds.
extern Double      J2000;          //!< J2000 in mjd, 51544.5.
extern std::string STRING_J2000;   //!< J2000 in mjd, in string

extern std::vector<Int>    MJD_UTC_GPS;   //!< Time of new introduced leap second.
extern std::vector<Double> DELTA_UTC_GPS; //!< Leap seconds relative to GPS time.
